class Solution {
    ...
    private boolean dfs(int row, int col, int indexAt) {
        ...
        final var up = dfs(row-1, col, indexAt+1);
        final var right = dfs(row, col+1, indexAt+1);
        final var down =  dfs(row+1, col, indexAt+1);
        final var left = dfs(row, col-1, indexAt+1);
